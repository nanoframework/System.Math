...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/nanoFramework.System.Math/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update nanoFramework.System.Math version to $env:MyNuGetVersion"
